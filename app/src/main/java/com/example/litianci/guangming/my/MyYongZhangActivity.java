...
public class MyYongZhangActivity extends BaseActivity implements PullToRefreshSwipeMenuListView.IXListViewListener, AbsListView.OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gwglList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MyYongZhangActivity.this, YongZhangXQActivity.class);
    ...
    public void getRequest(String string) {
        ...
        params.put(Globals.WS_POST_KEY, "{\"Ac\": \"SealW\",\"Para\": {\"Sid\": \"" + User.sid + "\",\"Search\": \"" + string + "\",\"Page\": \"" + page + "\"}}");
        ...
        new VolleyUtil() {
            ...
            public <T> boolean analysisData(String response) {
                ...
                if (result == null || !(result.getStu() == 1)) {
                    Toast.makeText(MyYongZhangActivity.this, Globals.SER_ERROR,
                    ...
                    if (flsh) {
                        ...
                        RefreshTime.setRefreshTime(MyYongZhangActivity.this, df.format(new Date()));
                        resultAdapter.setData(firstList);
                        resultAdapter.notifyDataSetChanged();
                        gwglList.setRefreshTime(RefreshTime.getRefreshTime(MyYongZhangActivity.this));
                        ...
                        if (isFlsh) {
                            ...
                            resultAdapter = new CommonAdapter<YongzhangResult.RstBean.ListBean>(MyYongZhangActivity.this, firstList, R.layout.item_list_yongzhang) {
                                @Override
                            ...
                            if (firstList.size() != 0) {
                                ...
                                Toast.makeText(MyYongZhangActivity.this, "没有更多数据了", Toast.LENGTH_SHORT).show();
                                onLoad();
                            }
                        }
        ...
        }.volleyStringRequestPost(MyYongZhangActivity.this, params, "app?", null);
    }
