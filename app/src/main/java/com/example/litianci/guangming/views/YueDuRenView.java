...
public abstract class YueDuRenView {
     ...
     *
     * @param context     上下文
     * @param btDetermine 确定按钮String
     * @param btDismiss   取消按钮String
     * @return
     */
    // 展示阅读人员
    public YueDuRenView deleteDialog(Context context,
        ...
        dialog.show();
        dialog.getWindow().setContentView(R.layout.item_alreadyread);
        TextView textView1 = (TextView) dialog
                .findViewById(R.id.tv1);
        TextView textView2 = (TextView) dialog
                .findViewById(R.id.tv2);
        textView1.setText(btDetermine);
        textView2.setText(btDismiss);
        return null;
