...
//        qingjiaH5.loadUrl(s);
        ...
        if (title.equals("发文申请")) {
            setTranslucentStatus();
            qingjiaH5.loadUrl(Globals.MY_URL + "oa_office/startup.cmd?$ACTION=startup&flowcode=f01");
        }

        if (title.equals("请假申请")) {
            setTranslucentStatus();
//            shenqingFj.setVisibility(View.VISIBLE);
            qingjiaH5.loadUrl(Globals.MY_URL + "oa_office/startup.cmd?$ACTION=startup&flowcode=f02");

        }
        if (title.equals("车辆使用申请")) {
            setTranslucentStatus();
            qingjiaH5.loadUrl(Globals.MY_URL + "oa_office/startup.cmd?$ACTION=startup&flowcode=f06");
        }
        if (title.equals("会议申请")) {
            setTranslucentStatus();
//            shenqingFj.setVisibility(View.VISIBLE);
            qingjiaH5.loadUrl(Globals.MY_URL + "oa_office/startup.cmd?$ACTION=startup&flowcode=f04");
        }
        if (title.equals("通知公告发布申请")) {
            setTranslucentStatus();
//            shenqingFj.setVisibility(View.VISIBLE);
            qingjiaH5.loadUrl(Globals.MY_URL + "oa_office/startup.cmd?$ACTION=startup&flowcode=f05");
        }
        if (title.equals("用章申请")) {
            setTranslucentStatus();
//            shenqingFj.setVisibility(View.VISIBLE);
            qingjiaH5.loadUrl(Globals.MY_URL + "oa_office/startup.cmd?$ACTION=startup&flowcode=f03");
        }
        if (title.equals("换班申请")) {
            setTranslucentStatus();
//            shenqingFj.setVisibility(View.VISIBLE);
            qingjiaH5.loadUrl(Globals.MY_URL + "oa_office/startup.cmd?$ACTION=startup&flowcode=f07");
        }
        if (title.equals("工作通知")) {
            setTranslucentStatus();
//            shenqingFj.setVisibility(View.VISIBLE);
            qingjiaH5.loadUrl(Globals.MY_URL + "oa_office/startup.cmd?$ACTION=startup&flowcode=f08");
        }
