...
/**
 * Created by litianci on 2018/1/31.
 */
...
public class FragmentHome3 extends Fragment implements View.OnClickListener {
    ...
    TextView tvMore;
    @Bind(R.id.gv_rcbg)
    ListViewForScrollView gvRcbg;

    @Bind(R.id.gv_zlcs)
    ListViewForScrollView gvZlcs;
    @Bind(R.id.gv_gzgl)
    ListViewForScrollView gvGzgl;
    @Bind(R.id.gv_hygl)
    ListViewForScrollView gvHygl;
    @Bind(R.id.gv_clgl)
    ListViewForScrollView gvClgl;
...
//                    break;
    ...
    public void onResume() {
        ...
        adapter1 = new CommonAdapter<Map<String, Object>>(getActivity(), item1, R.layout.item_list_home) {
            @Override
        ...
        adapter2 = new CommonAdapter<Map<String, Object>>(getActivity(), item2, R.layout.item_list_home) {
            @Override
            public void convert(ViewHolder holder, Map<String, Object> o) {
                holder.setImageResource(R.id.image, (Integer) o.get("imageItem")).setText(R.id.text, (String) o.get("textItem"));
            }
        };
        adapter3 = new CommonAdapter<Map<String, Object>>(getActivity(), item3, R.layout.item_list_home) {
            @Override
            public void convert(ViewHolder holder, Map<String, Object> o) {
        ...
        adapter5 = new CommonAdapter<Map<String, Object>>(getActivity(), item5, R.layout.item_list_home) {
            @Override
            public void convert(ViewHolder holder, Map<String, Object> o) {
                holder.setImageResource(R.id.image, (Integer) o.get("imageItem")).setText(R.id.text, (String) o.get("textItem"));
            }
        };
        adapter6 = new CommonAdapter<Map<String, Object>>(getActivity(), item6, R.layout.item_list_home) {
            @Override
            public void convert(ViewHolder holder, Map<String, Object> o) {
