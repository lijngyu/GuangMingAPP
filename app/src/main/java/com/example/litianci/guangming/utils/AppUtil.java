...
//		Log.i(Globals.LOG_I, "我的用户名：" + User.sid);
...
//		login.setUseridcode(User.useridcode);
...
//
//			}
//		}.protocolBuffer(context, Globals.WS_URI, index, null);
	}
...
/**下载文件的分割方法*/
	public static String wenjianDivision(String pk, String name, String url){
		...
		String myname=filenames.substring(4,14);
