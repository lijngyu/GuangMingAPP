...
public class Main2Activity extends FragmentActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
...
//
    ...
    public void Btnhome() {
        if (anInt != 1) {
            ...
            // 替换当前的页面
            fragmentTransaction.replace(R.id.frame_content, fragmentHome2);
            // 事务管理提交
...
//        plusImageView.setSelected(true);
    ...
    private void showPopupWindow(View parent) {
        if (popWindow == null) {
            ...
            adapter2 = new CommonAdapter<Map<String, Object>>(Main2Activity.this, items, R.layout.grid_item1) {
                @Override
