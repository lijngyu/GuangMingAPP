...
public class TitleBarView extends RelativeLayout {
	...
	private void ApplyStyle(Context context, AttributeSet attrs) {
		...
		BackImage = context.getResources().getDrawable(R.mipmap.back);
		BackPressImage = context.getResources().getDrawable(R.mipmap.back);
		...
		if(array.getBoolean(R.styleable.TitleBarView_leftButtonEnable, SignedBack)){
			...
			imbBack.setImageDrawable(
					context.getResources().getDrawable(
							array.getResourceId(R.styleable.TitleBarView_leftButtonBgImg, R.mipmap.back
									)));
